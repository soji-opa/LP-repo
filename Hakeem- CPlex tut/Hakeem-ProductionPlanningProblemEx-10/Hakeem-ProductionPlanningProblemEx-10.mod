 ...
 * OPL 22.1.0.0 Model
 * Author: naruto
 * Creation Date: Jan 26, 2023 at 11:44:24 AM
 *********************************************/
...
//Whenever we have to access tuple data, we have to use '.'
//e.g. Product[p].incost - we are accessing the input cost of in the tuple typeProductData
